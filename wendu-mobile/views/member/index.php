...
\mobile\assets\AppAsset::addCss($this,'template/css/my.css');
...
<ul class="myul">
    <li>
        <a href="<?= Url::to(['member/pay'],true) ?>">
            <div class="firstLi">
                <img src="/template/img/my_06.png" alt="">
                <div>书币充值</div>
            </div>
            <div class="secondLi">
                <div>书币余额:<span><?= $this->context->user->property->buy ?? 0 ?></span></div>
                <img src="/template/img/my_19.png" alt="">
            </div>
        </a>
    </li>
    <!--<li>
        <a href="bookshelf.html">
            <div class="firstLi">
                <img src="/template/img/my_09.png" alt="">
                <div>我的书卷</div>
            </div>
            <div class="secondLi">
    ...
    <li>
        <a href="link.html">
            <div class="firstLi">
                <img src="/template/img/my_11.png" alt="">
                <div>邀请好友</div>
            </div>
            <div class="secondLi">
    ...
    <li>
        <a href="<?= Url::to(['member/order/index'],true) ?>">
            <div class="firstLi">
                <img src="/template/img/my_13.png" alt="">
                <div>充值记录</div>
            </div>
            <div class="secondLi">
                <img src="/template/img/my_19.png" alt="">
    ...
    <li>
        <a href="<?= Url::to(['member/reader'],true) ?>">
            <div class="firstLi">
                <img src="/template/img/my_15.png" alt="">
                <div>阅读足迹</div>
            </div>
            <div class="secondLi">
                <img src="/template/img/my_19.png" alt="">
    ...
    <li>
        <a href="<?= Url::to(['member/service'],true) ?>">
            <div class="firstLi">
                <img src="/template/img/my_17.png" alt="">
                <div>联系客服</div>
            </div>
            <div class="secondLi">
                <img src="/template/img/my_19.png" alt="">
    ...
    <!--<li>
        <a href="link.html">
            <div class="firstLi">
                <img src="/template/img/my_23.png" alt="">
                <div>手机绑定</div>
            </div>
            <div class="secondLi">
                <div>绑定手机号</div>
    ...
    <li>
        <a href="<?= Url::to(['site/logout'],true) ?>">
            <div class="firstLi">
                <img src="/template/img/my_18.png" alt="">
                <div>退出登陆</div>
            </div>
        </a>
    </li>
