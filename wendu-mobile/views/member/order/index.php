...
\mobile\assets\AppAsset::addCss($this,'template/css/consumeRecord.css');

/*预加载JS*/
//'js/jquery-1.10.1.min.js',
\mobile\assets\AppAsset::addScript($this,'template/js/mobile.js?v1.7');
...
<header>
    <div class="head">
        <a href="<?= Url::to(['member/index']) ?>">
            <img src="/template/img/arrow-l.png" alt="">
        </a>
