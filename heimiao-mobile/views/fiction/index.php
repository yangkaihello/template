...
\mobile\assets\AppAsset::addCss($this,'css/detail.css');
...
<div class="foot">
    <div class="footcontent">
        <ul class="footUl">
            <li class='dashang'>
                <img src="/img/detail_17.jpg" alt="">
                <div class='footer-info'>打赏</div>
            </li>
            <li class='fenxiang'>
                <img src="/img/detail_19.jpg" alt="">
                <div class='footer-info'>分享</div>
            </li>
            <li>
                <img src="/img/detail_21.jpg" alt="">
...
<div style='display:none;' class="screen reward-dialog-box">
    <div class="reward-dialog">
        ...
        <div class="prizeList">
            <div class="prize">
                <div class="prize-icon"><img src="/img/red-wine.png" alt=""></div>
                <p class='prize-name'>红酒</p>
                <p class='prize-gold'>50金币</p>
            </div>
            <div class="prize">
                <div class="prize-icon"><img src="/img/Diamonds.png" alt=""></div>
                <p class='prize-name'>钻石</p>
                <p class='prize-gold'>50金币</p>
            </div>
            <div class="prize">
                <div class="prize-icon"><img src="/img/sedan.png" alt=""></div>
                <p class='prize-name'>轿车</p>
                <p class='prize-gold'>50金币</p>
            </div>
            <div class="prize">
                <div class="prize-icon"><img src="/img/house.png" alt=""></div>
                <p class='prize-name'>别墅</p>
                <p class='prize-gold'>50金币</p>
            </div>
            <div class="prize">
                <div class="prize-icon"><img src="/img/yacht.png" alt=""></div>
                <p class='prize-name'>游艇</p>
                <p class='prize-gold'>50金币</p>
            </div>
            <div class="prize">
                <div class="prize-icon"><img src="/img/plane.png" alt=""></div>
