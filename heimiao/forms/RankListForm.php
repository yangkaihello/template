...
class RankListForm extends Model
{
     ...
     */
    public function getRankGive($pageSize = 10)
    {
     ...
     * @return array(FictionIndex,Pagination)
     */
    public function getRankPv($pageSize = 10)
    {
     ...
     * @return array(FictionIndex,Pagination)
     */
    public function getRankCollect($pageSize = 10)
    {
     ...
     * @return array(FictionIndex,Pagination)
     */
    public function getRankEnd($pageSize = 10)
    {
